...
const PRESET_TEMPLATES: HookTemplate[] = [
  {
    ...
    example:
      '借着微弱月光，他终于看清了黑衣人的真面目——那张脸上，赫然刻着三年前早已死去的兄长胎记！',
  },
  {
    id: 'tpl-battle-cut',
    type: 'battle_cut',
  ...
  },
  {
    ...
    example:
      '血煞大阵的猩红光柱直冲云霄，玉简上的倒计时只剩最后三息，而通往生门唯一的钥匙，已在刚才彻底粉碎。',
  },
  {
    id: 'tpl-crisis',
    type: 'crisis',
    ...
    example:
      '就在全场为他欢呼的刹那，整座大殿轰然坍塌，虚空裂开万里沟壑，一双遮天蔽日的血色巨眸缓缓睁开。',
  },
  {
    id: 'tpl-anomaly',
    type: 'anomaly',
  ...
  },
  {
    ...
    example:
      '一边是全城数十万生灵，一边是至亲挚爱的性命。天平两侧皆是深渊，他手中的剑，究竟该指向何方？',
  },
]
