...
export interface BrainstormSparkRecord {
  id: string
  projectId: string
...
export interface BrainstormRepository {
  getAll(projectId: string): Promise<BrainstormSparkRecord[]>
  get(id: string): Promise<BrainstormSparkRecord | undefined>
  save(record: BrainstormSparkRecord): Promise<void>
