...
const METHODOLOGY = [
  {
    title: '先定位再动笔',
    body: '开书前先填作品定位：赛道、平台、读者、卖点没想清楚就动笔，多半会切书。',
  },
  {
    title: '全书总纲先行',
    body: '动笔前总纲必填：主线一句话、大结局、分卷规划一览；每卷结束回看修订一次。',
  },
  {
    title: '世界观三层填法',
    body: '底层法则（定了不改）→社会文明（前十章展开）→细节（随写随补）。世界观是舞台不是字典。',
  },
  {
    title: '等级表是宪法',
    body: '力量体系的等级一旦正文发布尽量不改；定稿前先写三章试水，检验数值是否膨胀。',
  },
  {
    title: '角色三档分级',
    body: '主要角色=核心；次要角色=阶段性宿敌/导师/配角；NPC=功能型。戏份变了及时升降级。',
  },
  { title: '问答法深挖动机', body: '对着角色卡连问三个“为什么”，问到第三个为什么，动机才立得住。' },
  { title: '随写随登记', body: '正文里每写出一个新设定立刻回表登记，连载百万字后你会感谢这套表。' },
  {
    title: '伏笔与前置条件',
    body: '伏笔登记时同步写清“回收前读者需要知道什么”——前置没铺就强行回收，效果大打折扣。',
  },
  { title: '每章结尾必有钩子', body: '网文和传统文学最大的区别；连载形态下章末平淡=流失读者。' },
  {
    title: '改设定先过设定变更',
    body: '连载中要改设定，先登记旧值新值、影响范围、已发布冲突——冲突未处理前不发布后续章节。',
  },
  {
    title: '知情权限随时登记',
    body: '读者对“谁知道什么”记得比你牢；每当有角色知悉秘密当天登记，防泄密穿帮。',
  },
        ...
        <div className="p-5 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
          {METHODOLOGY.map((item, idx) => (
            ...
            >
              ...
              <div className="text-[11px] text-[var(--ink-text-muted)] leading-relaxed mt-1">
                {item.body}
              </div>
            </div>
          ))}
